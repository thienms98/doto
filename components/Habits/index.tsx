              ...
              <Field data-invalid={isInvalid}>
                ...
                <RadioGroup defaultValue="daily" className="flex">
                  <div className="flex items-center gap-3">
                    ...
                    <Label htmlFor="daily" className={buttonVariants({ variant: field.state.value === 'daily' ? 'default' : 'outline' })}>
                      Daily
                    </Label>
                  </div>
                  <div className="flex items-center gap-3">
                    <RadioGroupItem value="weekly" id="weekly" hidden className="peer" />
                    <Label htmlFor="weekly" className={buttonVariants({ variant: field.state.value === 'weekly' ? 'default' : 'outline' })}>
                      Weekly
                    </Label>
                  </div>
                  <div className="flex items-center gap-3">
                    <RadioGroupItem value="monthly" id="monthly" hidden className="peer" />
                    <Label htmlFor="monthly" className={buttonVariants({ variant: field.state.value === 'monthly' ? 'default' : 'outline' })}>
                      Monthly
                    </Label>
                  </div>
                </RadioGroup>
